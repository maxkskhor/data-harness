...
class TestDirectoryRendering:
    def test_directory_in_load_connectors_schema(self):
        ...
        assert "market_data" in spec.description or "market_data" in json.dumps(spec.input_schema)
...
class TestLargeDataframeHandling:
    def test_connector_result_cached_not_inline(self):
        ...
        result = registry.call_connector("market_data__fetch_ohlcv", {"symbol": "AAPL"}, cache=cache)
